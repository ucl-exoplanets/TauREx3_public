...
class TaurexGasProfile(GasProfile):
    ...
    def __init__(self,name,active_gases,active_gas_mix_ratio,n2_mix_ratio=0,he_h2_ratio=0.1764):
        super().__init__(name)
    ...
    def add_active_gas_param(self,idx):
        ...
        def read_mol(self,idx=idx):
            return self.active_gas_mix_ratio[idx]
        def write_mol(self,value,idx=idx):
            self.active_gas_mix_ratio[idx] = value
    ...
    def add_surface_param(self):
        for idx,mol_name in enumerate(self.active_complex_gases):
            ...
            def read_surf(self,idx=idx):
                return self.active_gases_mixratios_surface[idx]
            def write_surf(self,value,idx=idx):
                self.active_gases_mixratios_surface[idx] = value
    ...
    def add_top_param(self):
        for idx,mol_name in enumerate(self.active_complex_gases): 
            ...
            def read_top(self,idx=idx):
                return self.active_gases_mixratios_top[idx]
            def write_top(self,value,idx=idx):
                self.active_gases_mixratios_top[idx] = value
