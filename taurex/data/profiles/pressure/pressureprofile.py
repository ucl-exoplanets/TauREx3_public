...
class SimplePressureProfile(PressureProfile):
    ...
    @fitparam(param_name='atm_min_pressure',param_latex='$P_\mathrm{min}$',default_mode='log',default_fit=False,default_bounds=[0.1,1.0])
    ...
    @fitparam(param_name='atm_max_pressure',param_latex='$P_\\mathrm{max}$',default_mode='log',default_fit=False,default_bounds=[0.1,1.0])
