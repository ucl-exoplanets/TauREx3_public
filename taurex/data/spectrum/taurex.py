    ...
    def _load_from_hdf5(self, filename):
        ...
        with h5py.File(filename, 'r') as f:
            try:
                ...
                self.error('Could not find instrument outputs in HDF5, this was '
                           'caused either by the HDF5 being a retrieval output '
                           'Or not running with some form of instrument in the forward model'
                           ' input par file')
